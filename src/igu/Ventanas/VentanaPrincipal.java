...
public class VentanaPrincipal extends JFrame {
	...
	private JScrollPane scllObservacionModificar;
	private JTextArea txtObservacionModificar;
...
//	}
		...
		if (btModificar == null) {
			...
			btModificar.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					getScllObservacionModificar().setVisible(false);
					getScllObservacionModificar().setEnabled(false);
	...
	private JPanel getPnModificarCita() {
		if (pnModificarCita == null) {
			...
			pnModificarCita.add(getScllObservacionModificar());
		}
...
//		String fechafin = formateaFecha(ultima);
				...
				public void actionPerformed(ActionEvent e) {
					...
					if (respuesta == JOptionPane.YES_OPTION) {
						...
						sol.cuerpo="Medico ID: " + idM + " Fecha: " + fecha.toString() + " Inicio: " + fechaInicio.toString() + " Fin: " + fechaFin.toString()
								+ " Sala: " + sala;
						sol.observaciones = getTxtObservacionModificar().getText();
						new AddSolicitudAction(sol).execute();
					}
	...
	private JScrollPane getScllObservacionModificar() {
		if (scllObservacionModificar == null) {
			scllObservacionModificar = new JScrollPane();
			scllObservacionModificar.setBounds(425, 233, 210, 95);
			scllObservacionModificar.setViewportView(getTxtObservacionModificar());
		}
		return scllObservacionModificar;
	}
	private JTextArea getTxtObservacionModificar() {
		if (txtObservacionModificar == null) {
			txtObservacionModificar = new JTextArea();
		}
		return txtObservacionModificar;
	}
}
